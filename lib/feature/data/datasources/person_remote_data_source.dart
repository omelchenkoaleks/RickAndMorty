...
abstract class PersonRemoteDataSource {
  ...
  Future<List<PersonModel>> searchPeson(String query);
}
...
class PersonRemoteDataSourceImpl implements PersonRemoteDataSource {
  ...
  @override
  Future<List<PersonModel>> searchPeson(String query) => _getPersonFromUrl('https://rickandmortyapi.com/api/character/?name=$query');
